...
ledErrorBlinkPattern_t error_led_table[NUM_OF_ERRORS] = {
  {{0,0},{0,0},{0,0},{0,0}}, //no_error
  {{0,0},{0,0},{0,0},{0,0}},//thermal_runaway,
  {{0,0},{0,0},{0,0},{0,0}},//low_voltage,
  {{0,0},{0,0},{0,0},{0,0}},//ground_fault,
  {{0,0},{0,0},{0,0},{0,0}},//arc_fault,
  {{0,0},{0,0},{0,0},{0,0}},//trp_no_indication,
  {{0,0},{0,0},{0,0},{0,0}},//trp_gfci_load_gf,
  {{0,0},{0,0},{0,0},{0,0}},//trp_series_arc,
  {{0,0},{0,0},{0,0},{0,0}},//trp_parallel_arc,
  {{0,0},{0,0},{0,0},{0,0}},//trp_overvoltage,
  {{0,0},{0,0},{0,0},{0,0}},//trp_af_slf_tst_fail,
  {{0,0},{0,0},{0,0},{0,0}},//trp_gfci_slf_tst_fail,
  {{0,0},{0,0},{0,0},{0,0}},//hot_attch_plug,
  {{0,0},{0,0},{0,0},{0,0}},//hot_receptacle,
  {{0,0},{0,0},{0,0},{0,0}},//no_load_at_pwr_up,
  {{0,0},{0,0},{0,0},{0,0}},//full_cap_confirmed,
  {{0,0},{0,0},{0,0},{0,0}},//mrg_cap_confirmed,
  {{0,0},{0,0},{0,0},{0,0}},//load_prsnt_at_pwr,
  {{0,0},{0,0},{0,0},{0,0}},//ext_volt_dips_det,
  {{0,0},{0,0},{0,0},{0,0}},//boot_up,
  {{0,0},{0,0},{0,0},{0,0}},//sd card error,      
  {{0,0},{0,0},{0,0},{0,0}},//unknown_trip,
  {{0,0},{0,0},{0,0},{0,0}},//sensor_error,
  {{0,0},{0,0},{0,0},{0,0}},//clock_bat
};
